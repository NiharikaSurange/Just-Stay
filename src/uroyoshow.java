 ...
 */
@WebServlet("/uroyoshow")
public class uroyoshow extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/juststay","root","root");
			...
			if(rs.next())
			{
				...
				do
				{
					...
					out.println("<td>");
					//out.println("</tr>");
					out.println("<form action=oyobook>");
